  ...
  methods: {
    ...
    update() {
      this.$apollo
        .mutate({
          mutation: gql`
            mutation($id: Int, $email: String!, $firstName: String!, $lastName: String!, $jobTitle: String, $role: String, $status: String) {
              editProfile(id: $id, email: $email, firstName: $firstName, lastName: $lastName, jobTitle: $jobTitle, role: $role, status: $status)
            }
          `,
          variables: {
            ...this.user,
